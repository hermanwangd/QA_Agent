# pi-run v0.2.4 Release Check

Date: 2026-07-05 Asia/Taipei

Status: `RELEASE_FOUND_PI_RUN_EXECUTED`

Scope: release-asset-only precheck for `Auto_Regression_Test_Framework` v0.2.4. Source archives were not used.

## Result

`v0.2.4` is published and was pi-run from release assets only.

## Evidence

| Check | Result |
|---|---|
| `GET /repos/hermanwangd/Auto_Regression_Test_Framework/releases/tags/v0.2.4` | `200` |
| Published releases list | `v0.2.4`, `v0.2.3`, `v0.2.2`, `v0.2.1`, `v0.2.0` |
| Tags list | `v0.2.4`, `v0.2.3`, `v0.2.2`, `v0.2.1`, `v0.2.0` |
| Local `release-assets-v0.2.4` directory | present |
| Local `usage-kit-v0.2.4` directory | present |

Latest visible release:

| Tag | Published At | URL |
|---|---:|---|
| `v0.2.4` | `2026-07-05T12:57:06Z` | `https://github.com/hermanwangd/Auto_Regression_Test_Framework/releases/tag/v0.2.4` |

## Decision

pi-run execution was performed for v0.2.4. See `reports/pi-run-v0.2.4-goal-audit.md`.
...
Runtime guardrail: keep Java heap bounded, for example `-Xmx512m`, and use only lightweight containers unless a specific provider requires otherwise.
